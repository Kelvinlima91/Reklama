                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors"
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    @if($canEdit)
                                        <button type="button" title="Editar" class="p-1.5 rounded-lg bg-green-50 hover:bg-green-100 text-cv-green transition-colors">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                        </button>
                                    @else
                                        <button disabled title="Não editável" class="p-1.5 rounded-lg bg-gray-50 text-gray-300 cursor-not-allowed">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                        </button>
                                    @endif
                                    @if($canDelete)
                                        <button type="button" title="Eliminar" onclick="confirmarEliminar({{ $rec->id }})" class="p-1.5 rounded-lg bg-red-50 hover:bg-red-100 text-cv-red transition-colors">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                                        </button>
                                    @else
                                        <button disabled title="Não eliminável" class="p-1.5 rounded-lg bg-gray-50 text-gray-300 cursor-not-allowed">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                                        </button>
                                    @endif
                                </div>
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        @else
                                            <button disabled class="p-1.5 rounded-lg bg-gray-50 text-gray-300 cursor-not-allowed">
                                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                            </button>
                                        @endif
                                        @if($cd)
        ...
        <div class="max-w-2xl">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-100">
                    <p class="text-xs text-gray-400">Para alterar os seus dados, contacte o suporte em <span class="text-cv-blue">suporte@livroreclamacoes.cv</span></p>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function confirmarEliminar(id) {
        if (!confirm('Tem a certeza que deseja eliminar esta reclamação? Esta ação não pode ser desfeita.')) return;
        const form   = document.createElement('form');
        form.method  = 'POST';
        form.action  = '/reclamacoes/' + id;
    ...
    function markRead(el) {
        ...
        el.classList.remove('bg-blue-50/40', 'hover:bg-blue-50');
