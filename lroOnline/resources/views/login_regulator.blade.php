...
<head>
    ...
    <title>Acesso Regulador – Reklama Cabo Verde</title>
...
<div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-cv-navy pattern-dots flex-col justify-between p-14">
        ...
        <div class="blob w-48 h-48 bg-cv-green top-1/2 right-10 opacity-10"></div>
        ...
        <div class="relative z-10">
            <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-cv-red/20 border border-white/10 rounded-full text-xs text-red-300 font-semibold mb-6">
                ...
                Área Reservada a Reguladores
            </div>
            <h2 class="font-display text-4xl xl:text-5xl font-extrabold text-white leading-[1.15] mb-6">
                Supervisione e<br>
                proteja os <span class="text-cv-red">direitos</span><br>
                dos consumidores.
            </h2>
            <p class="text-blue-200 text-base leading-relaxed mb-10 max-w-sm">
                Aceda ao painel da DGPDC para supervisionar reclamações, gerir empresas e emitir autos de infração.
            </p>

            {{-- Stats --}}
            <div class="grid grid-cols-3 gap-4">
                <div class="bg-white/8 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                    <div class="font-display text-2xl font-extrabold text-white mb-0.5">12k+</div>
                    <div class="text-blue-300 text-xs">Reclamações</div>
                </div>
                <div class="bg-white/8 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                    <div class="font-display text-2xl font-extrabold text-cv-red mb-0.5">5</div>
                    <div class="text-blue-300 text-xs">Infrações ativas</div>
                </div>
                <div class="bg-white/8 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
        ...
        <div class="relative z-10">
            <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-white/10 border border-white/15 rounded-full text-xs text-blue-200">
                <svg class="w-3.5 h-3.5 text-cv-red" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                </svg>
                DGPDC · Direção-Geral de Proteção do Consumidor
            </div>
        </div>
    </div>
        ...
        <div class="relative w-full max-w-md animate-fade-up">
            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/60 p-8 sm:p-10">
                ...
                <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-red-50 border border-red-200 rounded-full text-xs text-cv-red font-semibold mb-6">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"/></svg>
                    Acesso Regulador · DGPDC
                </div>

                {{-- Heading --}}
                <div class="mb-8">
                    <h1 class="font-display text-3xl font-extrabold text-cv-navy mb-2">Bem-vindo de volta</h1>
                    <p class="text-gray-500 text-sm">Entre com as suas credenciais institucionais</p>
                </div>
                ...
                {{-- Form --}}
                <form method="POST" action="{{ route('regulador.login.post') }}" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}"
                                   placeholder="utilizador@dgpdc.gov.cv"
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <a href="#" class="text-xs text-cv-red hover:underline font-medium">Esqueceu?</a>
                        </div>
                        <div class="relative">
                            <div class="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                            ...
                            <span class="ml-1 text-xs text-gray-400 font-normal">(2FA)</span>
                        </label>
                        <div class="relative">
                            <div class="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400">
                            ...
                            <input type="text" name="codigo" value="{{ old('codigo') }}"
                                   placeholder="Ex: 123 456" maxlength="7"
                                   class="input-field tracking-[0.3em] font-mono @error('codigo') border-red-400 @enderror">
                        </div>
                        @error('codigo')
                        <p class="mt-1.5 text-xs text-red-500">{{ $message }}</p>
                        @else
                            <p class="text-xs text-gray-400 mt-1.5">Introduza o código gerado pela sua aplicação autenticadora.</p>
                            @enderror
                    </div>
                ...
                <div class="mt-6 flex items-start gap-2.5 p-3.5 bg-red-50 border border-red-100 rounded-xl">
                    ...
                    <p class="text-xs text-red-600 leading-relaxed">
                        Este acesso é restrito a funcionários autorizados da DGPDC. Todas as sessões são registadas e monitorizadas.
                    </p>
                </div>
            </div>
