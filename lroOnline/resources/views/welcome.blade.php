        ...
        <div class="flex justify-between items-center h-20">
            ...
            <a href="#inicio" class="flex items-center hover:opacity-85 transition-opacity">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 60" width="200" height="36">
                    ...
                    <!-- reklama text inside page -->
                    <text x="26" y="40" text-anchor="middle"
                          font-family="Sora,'Segoe UI',sans-serif"
                          font-size="9" font-weight="800"
                          fill="white" letter-spacing="0.4">reklama</text>
                    <!-- Exclamation red badge -->
                    ...
                    <text x="86" y="36"
                          ...
                          fill="#0D1B3E">reklama</text>
                    <!-- Tagline -->
                    <text x="88" y="52"
                          font-family="Inter,'Segoe UI',sans-serif"
                          font-size="9" font-weight="600"
                          fill="#1B4FD8" letter-spacing="2.5">CABO VERDE</text>
                </svg>
            </a>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div class="group bg-white border-2 border-blue-100 hover:border-cv-blue rounded-2xl p-7 transition-colors duration-200 reveal">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">
                        Proteger e defender os direitos dos consumidores cabo-verdianos, promovendo relações
                        equilibradas e justas no mercado de consumo.
                    </p>
                </div>
                ...
                <div class="group bg-white border-2 border-green-100 hover:border-cv-green rounded-2xl p-7 transition-colors duration-200 reveal">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">
                        Ser uma referência na proteção ao consumidor, garantindo um mercado transparente e
                        ético em todo o território nacional.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-14 reveal">
            ...
            <p class="mt-5 text-gray-500 max-w-2xl mx-auto">
                Conheça os seus direitos fundamentais como consumidor em Cabo Verde
            </p>
        </div>
...
<section id="legislacao" class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-14 reveal">
            ...
            <p class="mt-5 text-gray-500 max-w-2xl mx-auto">
                Enquadramento legal da proteção ao consumidor em Cabo Verde
            </p>
        </div>

        <div class="max-w-4xl mx-auto space-y-5">
            @foreach([
                ['cv-blue',  'M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3',
                  'Lei de Defesa do Consumidor',
                  'A Lei n.º 7/VIII/2011, de 14 de março, estabelece o regime jurídico da defesa do consumidor em Cabo Verde, definindo os direitos básicos dos consumidores e as obrigações dos fornecedores de bens e serviços.',
                  'Consultar legislação completa'],
                ['cv-green', 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
                  'Livro de Reclamações',
                  'O Decreto-Lei n.º 28/2015 regulamenta a obrigatoriedade do Livro de Reclamações para todos os estabelecimentos comerciais e de prestação de serviços, incluindo a modalidade eletrónica.',
                  'Consultar decreto-lei'],
                ['cv-red',   'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z',
                  'Práticas Comerciais Desleais',
                  'Legislação específica que proíbe práticas comerciais enganosas, agressivas ou que induzem o consumidor em erro, protegendo a transparência nas relações de consumo.',
                ...
                <div class="group flex items-start gap-6 bg-gradient-to-r from-{{ $color }}/5 to-white border border-{{ $color }}/20 hover:border-{{ $color }}/50 rounded-2xl p-7 transition-all duration-200 reveal">
                    ...
                    <div>
                        ...
                        {{-- Link (no action) --}}
                        <button type="button" class="text-sm font-semibold text-{{ $color }} hover:underline">
                            {{ $linkLabel }} →
                        </button>
                    </div>
                </div>
...
<section class="py-24 relative overflow-hidden bg-gradient-to-br from-cv-navy via-blue-900 to-cv-navy">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-14 text-center reveal">
            <button type="button"
                    class="px-12 py-4 bg-cv-red text-white font-display font-bold text-lg rounded-xl shadow-lg shadow-red-900/40 hover:bg-red-700 hover:-translate-y-0.5 transition-all duration-200">
                Fazer uma Reclamação
            </button>
        </div>
    </div>
...
<section id="contato" class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            {{-- Contact Form (display only, no action) --}}
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" placeholder="Seu nome"
                               class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-cv-blue focus:border-transparent transition-shadow">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea rows="4" placeholder="Escreva a sua mensagem..."
                                  class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-cv-blue focus:border-transparent transition-shadow resize-none"></textarea>
                    </div>
                    {{-- Submit button – no action --}}
                    <button type="button"
                            class="w-full py-3.5 bg-cv-blue text-white font-display font-bold rounded-xl hover:bg-blue-700 hover:-translate-y-0.5 shadow-md shadow-blue-200 transition-all duration-200">
                        Enviar Mensagem
                    </button>
                </div>
            </div>
                ...
                <div class="mb-5">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 60" width="180" height="32">
                        ...
                        <text x="86" y="36"
                              font-family="Sora,'Segoe UI',sans-serif"
                              font-size="28" font-weight="800"
                              fill="white">reklama</text>
                        <!-- Tagline -->
                        <text x="88" y="52"
                              font-family="Inter,'Segoe UI',sans-serif"
                              font-size="9" font-weight="600"
                              fill="#93C5FD" letter-spacing="2.5">CABO VERDE</text>
                    </svg>
                </div>
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm">
                    @foreach(['Página Inicial' => 'inicio', 'Quem Somos' => 'quem-somos', 'Direitos do Consumidor' => 'direitos', 'Legislação' => 'legislacao'] as $label => $anchor)
                        <li>
                            <a href="#{{ $anchor }}" class="text-blue-200 hover:text-white transition-colors">{{ $label }}</a>
                        </li>
                    @endforeach
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm">
                    @foreach(['Perguntas Frequentes', 'Guias e Manuais', 'Documentos Legais', 'Termos de Uso'] as $item)
                        <li>
                            <button type="button" class="text-blue-200 hover:text-white transition-colors">{{ $item }}</button>
                        </li>
                    @endforeach
                </ul>
            </div>
...
{{-- ═══════════════════════════════════════════════
     JAVASCRIPT – Mobile menu + scroll reveal
═══════════════════════════════════════════════ --}}
<script>
    // Mobile menu toggle
