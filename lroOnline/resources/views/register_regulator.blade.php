...
<head>
    ...
    <title>Registar Regulador – Reklama Cabo Verde</title>
    ...
    <style>
        ...
        .input-field:focus { border-color: #D32F2F; box-shadow: 0 0 0 3px rgba(211,47,47,0.10); }
        ...
        .input-no-icon:focus { border-color: #D32F2F; box-shadow: 0 0 0 3px rgba(211,47,47,0.10); }
...
<div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-cv-navy pattern-dots flex-col justify-between p-14">
        <div class="blob w-96 h-96 bg-cv-red top-0 -left-20"></div>
        <div class="blob w-64 h-64 bg-cv-blue bottom-10 right-0"></div>
        <div class="blob w-48 h-48 bg-cv-green top-1/2 left-10 opacity-10"></div>
        ...
        <div class="relative z-10">
            <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-cv-red/20 border border-white/10 rounded-full text-xs text-red-300 font-semibold mb-6">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"/></svg>
                Registo Institucional
            </div>
            <h2 class="font-display text-4xl xl:text-5xl font-extrabold text-white leading-[1.15] mb-6">
                Registe-se como<br>
                <span class="text-cv-red">regulador</span> da<br>
                plataforma oficial.
            </h2>
            <p class="text-blue-200 text-base leading-relaxed mb-10 max-w-sm">
                O acesso regulador é reservado a funcionários autorizados da DGPDC e entidades reguladoras do Governo de Cabo Verde.
            </p>
            <ul class="space-y-4">
                <li class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-cv-red/20 flex items-center justify-center flex-shrink-0">
                        <svg class="w-4 h-4 text-red-300" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                    </div>
                    <span class="text-blue-100 text-sm">Supervisione todas as reclamações do sistema</span>
                </li>
                <li class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-cv-red/20 flex items-center justify-center flex-shrink-0">
                        <svg class="w-4 h-4 text-red-300" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                    </div>
                    <span class="text-blue-100 text-sm">Emita autos de infração a empresas incumpridoras</span>
                </li>
                <li class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-cv-red/20 flex items-center justify-center flex-shrink-0">
                        <svg class="w-4 h-4 text-red-300" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                    </div>
                    <span class="text-blue-100 text-sm">Gira o registo de empresas e consumidores</span>
                </li>
                <li class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-cv-red/20 flex items-center justify-center flex-shrink-0">
                        <svg class="w-4 h-4 text-red-300" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                    </div>
                    <span class="text-blue-100 text-sm">Aceda a relatórios e estatísticas nacionais</span>
                </li>
            </ul>
        </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center bg-gray-50 relative overflow-hidden px-6 py-12">
        <div class="blob w-72 h-72 bg-cv-red top-0 right-0 opacity-5"></div>
        ...
        <div class="relative w-full max-w-md animate-fade-up">
            ...
            <div class="lg:hidden mb-10 text-center">
                <a href="/" class="inline-block">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 60" width="180" height="32">
                        ...
                        <text x="88" y="52" font-family="Inter,sans-serif" font-size="9" font-weight="600" fill="#D32F2F" letter-spacing="2.5">CABO VERDE</text>
                    </svg>
                </a>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/60 p-8 sm:p-10">
                ...
                <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-red-50 border border-red-200 rounded-full text-xs text-cv-red font-semibold mb-6">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"/></svg>
                    Registo Institucional · DGPDC
                </div>

                <div class="mb-7">
                    <h1 class="font-display text-3xl font-extrabold text-cv-navy mb-2">Criar Conta Regulador</h1>
                    <p class="text-gray-500 text-sm">Preencha os seus dados institucionais para solicitar acesso</p>
                </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" placeholder="Ex: Maria" class="input-field">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" placeholder="Ex: Silva" class="input-field">
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                            ...
                            <span class="ml-1 text-xs text-gray-400 font-normal">(DGPDC)</span>
                        </label>
                        <div class="relative">
                            <div class="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400">
                            ...
                            <input type="text" placeholder="Ex: DGPDC-2024-0042" class="input-field">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" placeholder="nome@dgpdc.gov.cv" class="input-field">
                        </div>
                    </div>

                    {{-- Telefone --}}
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Telefone de Serviço</label>
                        <div class="flex gap-2">
                            ...
                            <input type="tel" placeholder="260 89 00" class="input-no-icon flex-1">
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-2.5 pt-1">
                        <input type="checkbox" id="terms" class="w-4 h-4 mt-0.5 rounded border-gray-300 cursor-pointer accent-red-600 flex-shrink-0">
                        <label for="terms" class="text-sm text-gray-600 cursor-pointer leading-relaxed">
                            ...
                            <button type="button" class="text-cv-red font-semibold hover:underline">Termos de Utilização</button>
                            e a
                            <button type="button" class="text-cv-red font-semibold hover:underline">Política de Segurança</button>
                            da plataforma.
                        </label>
                    </div>
                    ...
                    {{-- Submit --}}
                    <button type="button"
                            class="w-full py-3.5 bg-cv-red text-white font-display font-bold text-base rounded-xl hover:bg-red-700 hover:-translate-y-0.5 shadow-md shadow-red-200 transition-all duration-200 mt-2">
                        Solicitar Acesso
                    </button>
                ...
                {{-- Security notice --}}
                <div class="mt-6 flex items-start gap-2.5 p-3.5 bg-red-50 border border-red-100 rounded-xl">
                    <svg class="w-4 h-4 text-cv-red flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
                    <p class="text-xs text-red-600 leading-relaxed">
                        O pedido será validado pela administração da DGPDC antes de ser ativado. Receberá um email de confirmação em até 24 horas.
                    </p>
                </div>

                <p class="mt-6 text-center text-sm text-gray-500">
                    Já tem conta de regulador?
                    <a href="/login-regulator" class="text-cv-red font-semibold hover:underline ml-1">Entrar aqui</a>
                </p>
            </div>

            <p class="mt-6 text-center">
                <a href="/" class="inline-flex items-center gap-1.5 text-sm text-gray-400 hover:text-cv-red transition-colors">
